...
\emph{documentation problem}---\todo{
  Was it AI generated? The `---` looks like so, and this can make reviewers unhappy. I wouldn't use it, esp. without any spacing.
  }extracting expertise into static SOPs\todo{Explain abbreviation at first use} or knowledge graphs. This discards the very\todo{very what?},
...
manufacturers \$47~million per year~\cite{panopto2023}\todo{2023 or 2018?}. When tribal
...
\end{figure}
\todo[inline]{I find Figure \ref{tab:landscape} font hard to read -- maybe we should stick to the style default? Also, the abbreviations in the table are not explained and make it hard to read. Examples should have proper references. Given all that, maybe let's just create LaTeX tables instead of images?}
...
\todo{Proper references for all these would be good.}
On the research side, Freire et al.\ deployed an LLM-based
...
capabilities\todo{I think they should be explained} derived from the CoALA taxonomy~\cite{sumers2024coala} and
...
knowledge gaps.
\todo[inline]{To me, sentences like ``not only \emph{sth}, but \emph{sth}'' (I mean casual dropping of emph/textbf) sound like they were fully generated by an LLM. Probably we don't our reviewers to have this impression.}
...
(Figure~\ref{fig:pipeline}) ensures the knowledge vessel\todo{The notion of KV is not really defined} \emph{continues
...
proposal}\todo{I feel this should be stated more clearly earlier}, not a finished system. We identify four open challenges that
...
preservation.
\todo[inline]{Major: we miss a section for ``Declaration on Generative AI'', which is required by the template. We should add a short statement on how we used GenAI in the writing of this paper.}
\todo[inline]{Major: I don't think this is correct bibliography style for this template. We should not have any "et al." defined manually. Any reason to not use BibTex?}
\newpage
